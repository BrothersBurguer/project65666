  ...
  return (
    <>
      <button
        ...
        title="Info"
        className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 rounded-full border-2 border-black text-black text-sm font-bold transition-all hover:shadow-md hover:scale-105"
      >
        i
      </button>
