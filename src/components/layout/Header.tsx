...
export function Header() {
  return (
    <header className="bg-white border-b border-gray-100">
      ...
      {/* Info */}
      <div className="max-w-5xl mx-auto px-3 sm:px-5 flex flex-col items-center text-center pt-1">
        <h1 className="font-black text-[1.75rem] leading-tight sm:text-2xl text-black">
          {storeInfo.name}
        </h1>
        ...
        <div className="flex gap-2 my-2">
          {storeInfo.socialLinks.instagram && (
            <a
              ...
              title="Instagram"
              className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 rounded-full border-2 border-black text-black text-xl transition-all hover:shadow-md hover:scale-105"
            >
              <svg
        ...
        {/* Detalhes */}
        <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-sm max-[360px]:text-xs py-0.5">
